...
public final class FirebaseInstanceIdInternalReceiver extends WakefulBroadcastReceiver {
    private static final Queue<Intent> f13117a = new LinkedList();
    private static final Queue<Intent> f13118b = new LinkedList();

    static int m18895a(Context context, String str, Intent intent) {
        Object obj = -1;
        switch (str.hashCode()) {
            case -842411455:
        ...
        switch (obj) {
            case null:
                f13117a.offer(intent);
                break;
            case 1:
                f13118b.offer(intent);
                break;
            default:
        ...
        return m18901c(context, intent2);
    }

    public static Intent m18896a() {
        return (Intent) f13117a.poll();
    }

    public static Intent m18897a(Context context, Intent intent) {
        return m18900b(context, "com.google.firebase.INSTANCE_ID_EVENT", intent);
    }

    public static Intent m18898b() {
        return (Intent) f13118b.poll();
    }

    public static Intent m18899b(Context context, Intent intent) {
        return m18900b(context, "com.google.firebase.MESSAGING_EVENT", intent);
    }

    private static Intent m18900b(Context context, String str, Intent intent) {
    ...
    private static int m18901c(Context context, Intent intent) {
        m18902d(context, intent);
        try {
    ...
    private static void m18902d(Context context, Intent intent) {
    ...
    public void onReceive(Context context, Intent intent) {
        if (intent != null) {
            ...
            if (intent2 == null) {
                ...
                m18895a(context, intent.getAction(), intent2);
            }
        }
    }
}
