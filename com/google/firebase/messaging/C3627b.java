...
class C3627b {
    static AppMeasurement f13159a;

    private static AppMeasurement m18973a(Context context) {
        if (null != null) {
            return f13159a;
        }
        try {
    ...
    public static void m18974a(Context context, Intent intent) {
        C3627b.m18975a(context, "_nr", intent);
    }

    private static void m18975a(Context context, String str, Intent intent) {
        ...
        AppMeasurement a = C3627b.m18973a(context);
        if (a != null) {
    ...
    public static void m18976b(Context context, Intent intent) {
        C3627b.m18979e(context, intent);
        C3627b.m18975a(context, "_no", intent);
    }

    public static void m18977c(Context context, Intent intent) {
        C3627b.m18975a(context, "_nd", intent);
    }

    public static void m18978d(Context context, Intent intent) {
        C3627b.m18975a(context, "_nf", intent);
    }

    private static void m18979e(Context context, Intent intent) {
        if (intent != null) {
