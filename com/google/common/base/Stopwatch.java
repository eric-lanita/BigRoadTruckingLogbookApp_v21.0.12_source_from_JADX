...
public final class Stopwatch {
    ...
    public String toString() {
        ...
        return Platform.formatCompact4Digits(((double) elapsedNanos) / ((double) TimeUnit.NANOSECONDS.convert(1, chooseUnit))) + " " + abbreviate(chooseUnit);
    }
    ...
    private static String abbreviate(TimeUnit timeUnit) {
        switch (C35061.$SwitchMap$java$util$concurrent$TimeUnit[timeUnit.ordinal()]) {
            case 1:
                return "ns";
            case 2:
                return "μs";
