...
public class GcmReceiver extends WakefulBroadcastReceiver {
    private static String f10981a = "gcm.googleapis.com/refresh";

    private void m17053a(Context context, Intent intent) {
        if (isOrderedBroadcast()) {
            setResultCode(500);
        }
        m17054b(context, intent);
        try {
    ...
    private void m17054b(Context context, Intent intent) {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if ("com.google.android.c2dm.intent.REGISTRATION".equals(intent.getAction()) || "google.com/iid".equals(stringExtra) || f10981a.equals(stringExtra)) {
