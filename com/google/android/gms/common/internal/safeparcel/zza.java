...
public class zza {
    ...
    private static void m16867a(Parcel parcel, int i, int i2) {
    ...
    private static void m16868a(Parcel parcel, int i, int i2, int i3) {
        if (i2 != i3) {
    ...
    public static int zzcm(Parcel parcel) {
        int zzcl = zzcl(parcel);
        int zza = zza(parcel, zzcl);
        int dataPosition = parcel.dataPosition();
        if (zzgm(zzcl) != 20293) {
            String str = "Expected object header. Got 0x";
            String valueOf = String.valueOf(Integer.toHexString(zzcl));
            throw new zza(valueOf.length() != 0 ? str.concat(valueOf) : new String(str), parcel);
        }
        zzcl = dataPosition + zza;
        if (zzcl >= dataPosition && zzcl <= parcel.dataSize()) {
            return zzcl;
        }
        throw new zza("Size read is invalid start=" + dataPosition + " end=" + zzcl, parcel);
    }
