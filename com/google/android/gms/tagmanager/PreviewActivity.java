...
public class PreviewActivity extends Activity {
    ...
    class C34231 implements OnClickListener {
        final /* synthetic */ PreviewActivity f12490a;

        C34231(PreviewActivity previewActivity) {
            this.f12490a = previewActivity;
        }
    ...
    private void m18059a(String str, String str2, String str3) {
        AlertDialog create = new Builder(this).create();
        create.setTitle(str);
        create.setMessage(str2);
        create.setButton(-1, str3, new C34231(this));
        create.show();
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        try {
            ...
            if (!TagManager.getInstance(this).m18063a(data)) {
                ...
                zzbn.zzcx(valueOf);
                m18059a("Preview failure", valueOf, "Continue");
            }
