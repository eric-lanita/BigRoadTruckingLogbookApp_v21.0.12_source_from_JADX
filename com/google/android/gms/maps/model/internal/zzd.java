...
public interface zzd extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzd {
        ...
        private static class zza implements zzd {
            private IBinder f12111a;

            zza(IBinder iBinder) {
                this.f12111a = iBinder;
            }
            ...
            public int getActiveLevelIndex() {
                ...
                try {
                    ...
                    this.f12111a.transact(1, obtain, obtain2, 0);
            ...
            public int getDefaultLevelIndex() {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.model.internal.IIndoorBuildingDelegate");
                    this.f12111a.transact(2, obtain, obtain2, 0);
                    obtain2.readException();
                    int readInt = obtain2.readInt();
                    return readInt;
                } finally {
            ...
            public List<IBinder> getLevels() {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.model.internal.IIndoorBuildingDelegate");
                    this.f12111a.transact(3, obtain, obtain2, 0);
                    obtain2.readException();
            ...
            public int hashCodeRemote() {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.model.internal.IIndoorBuildingDelegate");
                    this.f12111a.transact(6, obtain, obtain2, 0);
                    obtain2.readException();
                    int readInt = obtain2.readInt();
                    return readInt;
                } finally {
            ...
            public boolean isUnderground() {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.model.internal.IIndoorBuildingDelegate");
                    this.f12111a.transact(4, obtain, obtain2, 0);
                    obtain2.readException();
            ...
            public boolean zzb(zzd com_google_android_gms_maps_model_internal_zzd) {
                ...
                try {
                    ...
                    this.f12111a.transact(5, obtain, obtain2, 0);
                    obtain2.readException();
                    if (obtain2.readInt() != 0) {
                        z = true;
                    }
        ...
        public static zzd zziy(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            ...
            switch (i) {
                ...
                case 5:
                    parcel.enforceInterface("com.google.android.gms.maps.model.internal.IIndoorBuildingDelegate");
                    isUnderground = zzb(zziy(parcel.readStrongBinder()));
                    parcel2.writeNoException();
                    if (isUnderground) {
                        i3 = 1;
                    }
