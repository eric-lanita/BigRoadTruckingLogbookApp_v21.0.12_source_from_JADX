...
public class StreetViewPanoramaCamera extends AbstractSafeParcelable {
    ...
    private StreetViewPanoramaOrientation f12087b;
    ...
    StreetViewPanoramaCamera(int i, float f, float f2, float f3) {
        ...
        this.f12087b = new com.google.android.gms.maps.model.StreetViewPanoramaOrientation.Builder().tilt(f2).bearing(f3).build();
    }
    ...
    public String toString() {
        return zzaa.zzx(this).zzg("zoom", Float.valueOf(this.zoom)).zzg("tilt", Float.valueOf(this.tilt)).zzg("bearing", Float.valueOf(this.bearing)).toString();
    }

    public void writeToParcel(Parcel parcel, int i) {
        zzj.m17699a(this, parcel, i);
    }
}
