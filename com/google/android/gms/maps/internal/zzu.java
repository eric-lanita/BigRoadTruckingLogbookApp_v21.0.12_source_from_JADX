...
public interface zzu extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzu {
        ...
        private static class zza implements zzu {
            private IBinder f12004a;

            zza(IBinder iBinder) {
                this.f12004a = iBinder;
            }
            ...
            public boolean zza(zzf com_google_android_gms_maps_model_internal_zzf) {
                ...
                try {
                    ...
                    this.f12004a.transact(1, obtain, obtain2, 0);
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                case 1:
                    ...
                    boolean zza = zza(com.google.android.gms.maps.model.internal.zzf.zza.zzja(parcel.readStrongBinder()));
