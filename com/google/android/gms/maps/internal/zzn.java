...
public interface zzn extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzn {
        ...
        private static class zza implements zzn {
            private IBinder f11997a;

            zza(IBinder iBinder) {
                this.f11997a = iBinder;
            }
            ...
            public void zzg(zzf com_google_android_gms_maps_model_internal_zzf) {
                ...
                try {
                    ...
                    this.f11997a.transact(1, obtain, obtain2, 0);
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                case 1:
                    ...
                    zzg(com.google.android.gms.maps.model.internal.zzf.zza.zzja(parcel.readStrongBinder()));
