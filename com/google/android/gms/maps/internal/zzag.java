...
public interface zzag extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzag {
        ...
        private static class zza implements zzag {
            private IBinder f11982a;

            zza(IBinder iBinder) {
                this.f11982a = iBinder;
            }
            ...
            public void onSnapshotReady(Bitmap bitmap) {
                ...
                try {
                    ...
                    this.f11982a.transact(1, obtain, obtain2, 0);
            ...
            public void zzaf(zzd com_google_android_gms_dynamic_zzd) {
                ...
                try {
                    ...
                    this.f11982a.transact(2, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
        ...
        public static zzag zziq(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
