...
public interface zzk extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzk {
        ...
        private static class zza implements zzk {
            private IBinder f11994a;

            zza(IBinder iBinder) {
                this.f11994a = iBinder;
            }
            ...
            public void zza(zzc com_google_android_gms_maps_model_internal_zzc) {
                ...
                try {
                    ...
                    this.f11994a.transact(1, obtain, obtain2, 0);
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                case 1:
                    ...
                    zza(com.google.android.gms.maps.model.internal.zzc.zza.zzix(parcel.readStrongBinder()));
