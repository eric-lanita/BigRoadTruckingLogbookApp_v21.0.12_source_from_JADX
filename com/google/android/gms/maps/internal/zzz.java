...
public interface zzz extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzz {
        ...
        private static class zza implements zzz {
            private IBinder f12009a;

            zza(IBinder iBinder) {
                this.f12009a = iBinder;
            }
            ...
            public void zza(zzg com_google_android_gms_maps_model_internal_zzg) {
                ...
                try {
                    ...
                    this.f12009a.transact(1, obtain, obtain2, 0);
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                case 1:
                    ...
                    zza(com.google.android.gms.maps.model.internal.zzg.zza.zzjb(parcel.readStrongBinder()));
