...
public interface zzm extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzm {
        ...
        private static class zza implements zzm {
            private IBinder f11996a;

            zza(IBinder iBinder) {
                this.f11996a = iBinder;
            }
            ...
            public void zze(zzf com_google_android_gms_maps_model_internal_zzf) {
                ...
                try {
                    ...
                    this.f11996a.transact(1, obtain, obtain2, 0);
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                case 1:
                    ...
                    zze(com.google.android.gms.maps.model.internal.zzf.zza.zzja(parcel.readStrongBinder()));
