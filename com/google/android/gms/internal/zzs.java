...
public class zzs {
    ...
    static class zza {
        ...
        private final List<zza> f11740a = new ArrayList();
        ...
        private long m17555a() {
            if (this.f11740a.size() == 0) {
                return 0;
            }
            return ((zza) this.f11740a.get(this.f11740a.size() - 1)).time - ((zza) this.f11740a.get(0)).time;
        }
        ...
        public synchronized void zza(String str, long j) {
            ...
            this.f11740a.add(new zza(str, j, SystemClock.elapsedRealtime()));
        }

        public synchronized void zzd(String str) {
            this.f11741b = true;
            if (m17555a() > 0) {
                long j = ((zza) this.f11740a.get(0)).time;
                zzs.zzb("(%-4d ms) %s", Long.valueOf(r2), str);
                long j2 = j;
                for (zza com_google_android_gms_internal_zzs_zza_zza : this.f11740a) {
    ...
    private static String m17556a(String str, Object... objArr) {
        String valueOf;
        if (objArr != null) {
    ...
    public static void zza(String str, Object... objArr) {
        if (DEBUG) {
            Log.v(TAG, m17556a(str, objArr));
        }
    }

    public static void zza(Throwable th, String str, Object... objArr) {
        Log.e(TAG, m17556a(str, objArr), th);
    }

    public static void zzb(String str, Object... objArr) {
        Log.d(TAG, m17556a(str, objArr));
    }

    public static void zzc(String str, Object... objArr) {
        Log.e(TAG, m17556a(str, objArr));
    }
}
