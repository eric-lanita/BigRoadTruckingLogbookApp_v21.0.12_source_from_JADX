...
public final class zzano {
    static final Type[] f11193a = new Type[0];
    ...
    private static final class zzb implements Serializable, ParameterizedType {
        ...
        public int hashCode() {
            return (Arrays.hashCode(this.beA) ^ this.bez.hashCode()) ^ zzano.m17203b(this.bey);
        }
    ...
    private static int m17197a(Object[] objArr, Object obj) {
    ...
    private static Class<?> m17198a(TypeVariable<?> typeVariable) {
        GenericDeclaration genericDeclaration = typeVariable.getGenericDeclaration();
        return genericDeclaration instanceof Class ? (Class) genericDeclaration : null;
    }

    static Type m17199a(Type type, Class<?> cls, Class<?> cls2) {
        if (cls2 == cls) {
            return type;
        }
        if (cls2.isInterface()) {
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (cls2.isAssignableFrom(interfaces[i])) {
                    return m17199a(cls.getGenericInterfaces()[i], interfaces[i], (Class) cls2);
                }
            }
        }
        if (!cls.isInterface()) {
            ...
            while (cls3 != Object.class) {
                ...
                if (cls2.isAssignableFrom(superclass)) {
                    return m17199a(cls3.getGenericSuperclass(), superclass, (Class) cls2);
                }
                cls3 = superclass;
            }
        }
    ...
    static Type m17200a(Type type, Class<?> cls, TypeVariable<?> typeVariable) {
        Class a = m17198a((TypeVariable) typeVariable);
        if (a == null) {
            return typeVariable;
        }
        Type a2 = m17199a(type, (Class) cls, a);
        if (!(a2 instanceof ParameterizedType)) {
            return typeVariable;
        }
        return ((ParameterizedType) a2).getActualTypeArguments()[m17197a(a.getTypeParameters(), (Object) typeVariable)];
    }

    static boolean m17202a(Object obj, Object obj2) {
        return obj == obj2 || (obj != null && obj.equals(obj2));
    }

    private static int m17203b(Object obj) {
        return obj != null ? obj.hashCode() : 0;
    }

    static Type m17204b(Type type, Class<?> cls, Class<?> cls2) {
        zzann.zzbo(cls2.isAssignableFrom(cls));
        return zza(type, (Class) cls, m17199a(type, (Class) cls, (Class) cls2));
    }

    private static void m17205b(Type type) {
    ...
    public static Type zza(Type type, Class<?> cls) {
        Type b = m17204b(type, cls, Collection.class);
    ...
    public static Type zza(Type type, Class<?> cls, Type type2) {
        ...
        while (type3 instanceof TypeVariable) {
            ...
            type2 = m17200a(type, (Class) cls, (TypeVariable) type3);
            if (type2 == type3) {
                return type2;
            }
            type3 = type2;
    ...
    public static boolean zza(Type type, Type type2) {
        ...
        if (type instanceof ParameterizedType) {
            ...
            if (!(m17202a(parameterizedType.getOwnerType(), parameterizedType2.getOwnerType()) && parameterizedType.getRawType().equals(parameterizedType2.getRawType()) && Arrays.equals(parameterizedType.getActualTypeArguments(), parameterizedType2.getActualTypeArguments()))) {
                z = false;
            }
            return z;
    ...
    public static Type[] zzb(Type type, Class<?> cls) {
        ...
        Type b = m17204b(type, cls, Map.class);
    ...
    public static WildcardType zzc(Type type) {
        return new zzc(new Type[]{type}, f11193a);
    }
