...
public interface zzd extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzd {
        ...
        private static class zza implements zzd {
            private IBinder f12465a;

            zza(IBinder iBinder) {
                this.f12465a = iBinder;
            }
            ...
            public void zza(ConnectionResult connectionResult, AuthAccountResult authAccountResult) {
                ...
                try {
                    ...
                    this.f12465a.transact(3, obtain, obtain2, 0);
            ...
            public void zza(Status status, GoogleSignInAccount googleSignInAccount) {
                ...
                try {
                    ...
                    this.f12465a.transact(7, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void zzb(SignInResponse signInResponse) {
                ...
                try {
                    ...
                    this.f12465a.transact(8, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void zzea(Status status) {
                ...
                try {
                    ...
                    this.f12465a.transact(4, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void zzeb(Status status) {
                ...
                try {
                    ...
                    this.f12465a.transact(6, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
