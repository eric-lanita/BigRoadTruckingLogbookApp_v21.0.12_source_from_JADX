...
public class CustomTabActivity extends Activity {
    ...
    class C29821 extends BroadcastReceiver {
        C29821() {
        }
    ...
    protected void onActivityResult(int i, int i2, Intent intent) {
        ...
        if (i2 == 0) {
            ...
            C0265i.m1105a((Context) this).m1110a(intent2);
            this.closeReceiver = new C29821();
            C0265i.m1105a((Context) this).m1109a(this.closeReceiver, new IntentFilter(DESTROY_ACTION));
        }
    }

    protected void onDestroy() {
        C0265i.m1105a((Context) this).m1108a(this.closeReceiver);
        super.onDestroy();
    }
}
