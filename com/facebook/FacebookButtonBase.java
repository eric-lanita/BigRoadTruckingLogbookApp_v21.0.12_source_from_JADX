...
public abstract class FacebookButtonBase extends Button {
    ...
    class C29841 implements OnClickListener {
        C29841() {
        }
    ...
    protected FacebookButtonBase(Context context, AttributeSet attributeSet, int i, int i2, String str, String str2) {
        ...
        if (defaultStyleResource == 0) {
            defaultStyleResource = C3002R.style.com_facebook_button;
        }
        ...
        if (!isInEditMode()) {
            ...
            try {
                if (obtainStyledAttributes.hasValue(0)) {
                    ...
                    setBackgroundColor(C0126a.m584b(context, C3002R.color.com_facebook_blue));
                }
    ...
    private void setupOnClickListener() {
        super.setOnClickListener(new C29841());
    }
}
