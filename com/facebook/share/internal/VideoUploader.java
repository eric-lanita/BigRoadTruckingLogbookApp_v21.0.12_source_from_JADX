...
public class VideoUploader {
    ...
    static class C31391 extends AccessTokenTracker {
        C31391() {
        }
    ...
    private static abstract class UploadWorkItemBase implements Runnable {
        ...
        private boolean attemptRetry(int i) {
            ...
            VideoUploader.getHandler().postDelayed(new C31431(), (long) (((int) Math.pow(3.0d, (double) this.completedRetries)) * VideoUploader.RETRY_DELAY_UNIT_MS));
            return true;
        }
    ...
    private static class FinishUploadWorkItem extends UploadWorkItemBase {
        static final Set<Integer> transientErrorCodes = new C31401();

        static class C31401 extends HashSet<Integer> {
            C31401() {
    ...
    private static class StartUploadWorkItem extends UploadWorkItemBase {
        static final Set<Integer> transientErrorCodes = new C31411();

        static class C31411 extends HashSet<Integer> {
            C31411() {
    ...
    private static class TransferChunkWorkItem extends UploadWorkItemBase {
        static final Set<Integer> transientErrorCodes = new C31421();
        private String chunkEnd;
        private String chunkStart;

        static class C31421 extends HashSet<Integer> {
            C31421() {
    ...
    public static synchronized void uploadAsync(ShareVideoContent shareVideoContent, FacebookCallback<Result> facebookCallback) {
        synchronized (VideoUploader.class) {
            uploadAsync(shareVideoContent, "me", facebookCallback);
        }
    }

    public static synchronized void uploadAsync(ShareVideoContent shareVideoContent, String str, FacebookCallback<Result> facebookCallback) {
        synchronized (VideoUploader.class) {
            if (!initialized) {
    ...
    private static byte[] getChunk(UploadContext uploadContext, String str, String str2) {
