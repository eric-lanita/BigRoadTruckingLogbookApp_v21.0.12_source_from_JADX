...
public class LikeDialog extends FacebookDialogBase<LikeContent, Result> {
    ...
    protected void registerCallbackImpl(CallbackManagerImpl callbackManagerImpl, final FacebookCallback<Result> facebookCallback) {
        final ResultProcessor c31261 = facebookCallback == null ? null : new ResultProcessor(facebookCallback) {
        ...
        callbackManagerImpl.registerCallback(getRequestCode(), new Callback() {
            public boolean onActivityResult(int i, Intent intent) {
                return ShareInternalUtility.handleActivityResult(LikeDialog.this.getRequestCode(), i, intent, c31261);
            }
        });
    }
