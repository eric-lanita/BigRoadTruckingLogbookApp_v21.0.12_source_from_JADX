...
public class LikeActionController {
    ...
    static class C31143 implements Callback {
        C31143() {
        }
    ...
    static class C31165 extends AccessTokenTracker {
        C31165() {
        }
    ...
    class C31229 implements RequestCompletionCallback {
        C31229() {
        }
    ...
    private abstract class AbstractRequestWrapper implements RequestWrapper {
        ...
        class C31231 implements GraphRequest.Callback {
            C31231() {
            }
        ...
        protected void setRequest(GraphRequest graphRequest) {
            ...
            graphRequest.setCallback(new C31231());
        }
...
*/
    ...
    private static synchronized void performFirstInitialize() {
        synchronized (LikeActionController.class) {
            if (!isInitialized) {
                ...
                CallbackManagerImpl.registerStaticCallback(RequestCodeOffset.Like.toRequestCode(), new C31143());
                isInitialized = true;
            }
        }
    }
    ...
    private static void broadcastAction(LikeActionController likeActionController, String str, Bundle bundle) {
        ...
        C0265i.m1105a(FacebookSdk.getApplicationContext()).m1110a(intent);
    }
    ...
    private void refreshStatusAsync() {
        if (AccessToken.getCurrentAccessToken() == null) {
            ...
            fetchVerifiedObjectId(new C31229());
        }
    }
