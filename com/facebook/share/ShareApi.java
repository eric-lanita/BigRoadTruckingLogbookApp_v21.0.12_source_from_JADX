...
public final class ShareApi {
    ...
    class C31057 implements ValueMapper {
        C31057() {
        }
    ...
    private void shareOpenGraphContent(ShareOpenGraphContent shareOpenGraphContent, final FacebookCallback<Result> facebookCallback) {
        final Callback c30981 = new Callback() {
        ...
        stageOpenGraphAction(bundle, new OnMapperCompleteListener() {
            public void onComplete() {
                try {
                    ...
                    new GraphRequest(AccessToken.getCurrentAccessToken(), ShareApi.this.getGraphPath(URLEncoder.encode(action.getActionType(), ShareApi.DEFAULT_CHARSET)), bundle, HttpMethod.POST, c30981).executeAsync();
                } catch (Exception e) {
        ...
        try {
            for (SharePhoto sharePhoto : sharePhotoContent.getPhotos()) {
                try {
                    ...
                    if (bitmap != null) {
                        arrayList.add(GraphRequest.newUploadPhotoRequest(currentAccessToken, getGraphPath(PHOTOS_EDGE), bitmap, caption, sharePhotoCommonParameters, (Callback) c31003));
                    } else if (imageUrl != null) {
                        arrayList.add(GraphRequest.newUploadPhotoRequest(currentAccessToken, getGraphPath(PHOTOS_EDGE), imageUrl, caption, sharePhotoCommonParameters, (Callback) c31003));
                    }
                } catch (Exception e) {
                    ShareInternalUtility.invokeCallbackWithException(facebookCallback, e);
                    return;
    ...
    private void shareLinkContent(ShareLinkContent shareLinkContent, final FacebookCallback<Result> facebookCallback) {
        ...
        new GraphRequest(AccessToken.getCurrentAccessToken(), getGraphPath("feed"), bundle, HttpMethod.POST, c31014).executeAsync();
    }
    ...
    private <T> void stageCollectionValues(CollectionMapper.Collection<T> collection, OnMapperCompleteListener onMapperCompleteListener) {
        CollectionMapper.iterate(collection, new C31057(), onMapperCompleteListener);
    }
    ...
    private void stageOpenGraphObject(final ShareOpenGraphObject shareOpenGraphObject, final OnMapValueCompleteListener onMapValueCompleteListener) {
        ...
        CollectionMapper.Collection c31079 = new CollectionMapper.Collection<String>() {
            public Iterator<String> keyIterator() {
        ...
        stageCollectionValues(c31079, new OnMapperCompleteListener() {
            public void onComplete() {
