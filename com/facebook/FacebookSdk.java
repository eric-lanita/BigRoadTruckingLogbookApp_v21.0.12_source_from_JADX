...
public final class FacebookSdk {
    ...
    private static final int DEFAULT_THEME = C3002R.style.com_facebook_activity_theme;
    private static final ThreadFactory DEFAULT_THREAD_FACTORY = new C29861();
    ...
    static class C29861 implements ThreadFactory {
    ...
    static class C29872 implements Callable<File> {
        C29872() {
        }
    ...
    public static synchronized void sdkInitialize(final Context context, final InitializeCallback initializeCallback) {
        synchronized (FacebookSdk.class) {
            if (!sdkInitialized.booleanValue()) {
                ...
                cacheDir = new LockOnGetVariable(new C29872());
