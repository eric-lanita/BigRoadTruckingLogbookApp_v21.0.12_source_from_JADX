...
class WebViewLoginMethodHandler extends WebLoginMethodHandler {
    public static final Creator<WebViewLoginMethodHandler> CREATOR = new C30862();
    private String e2e;
    private WebDialog loginDialog;

    static class C30862 implements Creator {
        C30862() {
        }
    ...
    boolean tryAuthorize(final Request request) {
        ...
        OnCompleteListener c30851 = new OnCompleteListener() {
        ...
        this.loginDialog = new AuthDialogBuilder(activity, request.getApplicationId(), parameters).setE2E(this.e2e).setIsRerequest(request.isRerequest()).setOnCompleteListener(c30851).build();
