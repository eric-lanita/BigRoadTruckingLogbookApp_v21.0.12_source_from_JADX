...
public class DeviceAuthDialog extends DialogFragment {
    ...
    class C30651 implements OnClickListener {
        C30651() {
        }
    ...
    class C30662 implements Callback {
        C30662() {
        }
    ...
    class C30673 implements Runnable {
        C30673() {
        }
    ...
    class C30684 implements Callback {
        C30684() {
        }
    ...
    private static class RequestState implements Parcelable {
        public static final Creator<RequestState> CREATOR = new C30701();
        private long interval;
        private long lastPoll;
        private String requestCode;
        private String userCode;

        static class C30701 implements Creator<RequestState> {
            C30701() {
            }
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        ((Button) inflate.findViewById(C3002R.id.cancel_button)).setOnClickListener(new C30651());
    ...
    public void startLogin(Request request) {
        ...
        new GraphRequest(null, DEVICE_LOGIN_ENDPOINT, bundle, HttpMethod.POST, new C30662()).executeAsync();
    }
    ...
    private void schedulePoll() {
        this.scheduledPoll = DeviceAuthMethodHandler.getBackgroundExecutor().schedule(new C30673(), this.currentRequestState.getInterval(), TimeUnit.SECONDS);
    }

    private GraphRequest getPollRequest() {
        Bundle bundle = new Bundle();
        bundle.putString("code", this.currentRequestState.getRequestCode());
        return new GraphRequest(null, DEVICE_LOGIN_STATUS_ENDPOINT, bundle, HttpMethod.POST, new C30684());
    }
