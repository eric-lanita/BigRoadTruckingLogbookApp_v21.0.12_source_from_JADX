...
public class LoginFragment extends Fragment {
    ...
    class C30801 implements OnCompletedListener {
        C30801() {
        }
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.loginClient.setOnCompletedListener(new C30801());
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        final View inflate = layoutInflater.inflate(C3002R.layout.com_facebook_login_fragment, viewGroup, false);
        this.loginClient.setBackgroundProcessingListener(new BackgroundProcessingListener() {
            public void onBackgroundProcessingStarted() {
                inflate.findViewById(C3002R.id.com_facebook_login_activity_progress_bar).setVisibility(0);
            }

            public void onBackgroundProcessingStopped() {
                inflate.findViewById(C3002R.id.com_facebook_login_activity_progress_bar).setVisibility(8);
            }
        });
        return inflate;
    }
    ...
    public void onPause() {
        super.onPause();
        getActivity().findViewById(C3002R.id.com_facebook_login_activity_progress_bar).setVisibility(8);
    }
