...
public final class Profile implements Parcelable {
    public static final Creator<Profile> CREATOR = new C29992();
    ...
    static class C29981 implements GraphMeRequestWithCacheCallback {
        C29981() {
        }
    ...
    static class C29992 implements Creator {
        C29992() {
        }
    ...
    public static void fetchProfileForCurrentAccessToken() {
        ...
        if (currentAccessToken == null) {
            ...
            Utility.getGraphMeRequestWithCacheAsync(currentAccessToken.getToken(), new C29981());
        }
    }
