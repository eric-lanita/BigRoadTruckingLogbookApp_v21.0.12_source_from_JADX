...
public class TestUserManager {
    ...
    private AccessToken getAccessTokenForUser(List<String> list, Mode mode, String str) {
        ...
        return new AccessToken(createTestAccount.optString("access_token"), this.testApplicationId, createTestAccount.optString(ShareConstants.WEB_DIALOG_PARAM_ID), asList, null, AccessTokenSource.TEST_USER, null, null);
    }
