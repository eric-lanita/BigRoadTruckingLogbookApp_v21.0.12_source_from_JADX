...
public final class Utility {
    ...
    static class C30573 implements FilenameFilter {
        C30573() {
        }
    ...
    public static void getGraphMeRequestWithCacheAsync(final String str, final GraphMeRequestWithCacheCallback graphMeRequestWithCacheCallback) {
        ...
        graphMeRequestWithCache.setCallback(c30562);
    ...
    private static int refreshBestGuessNumberOfCPUCores() {
        ...
        try {
            File[] listFiles = new File("/sys/devices/system/cpu/").listFiles(new C30573());
            if (listFiles != null) {
