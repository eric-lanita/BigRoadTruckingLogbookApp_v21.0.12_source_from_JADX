...
public class BoltsMeasurementEventListener extends BroadcastReceiver {
    ...
    private void open() {
        C0265i.m1105a(this.applicationContext).m1109a(this, new IntentFilter(MEASUREMENT_EVENT_NOTIFICATION_NAME));
    }

    private void close() {
        C0265i.m1105a(this.applicationContext).m1108a((BroadcastReceiver) this);
    }
