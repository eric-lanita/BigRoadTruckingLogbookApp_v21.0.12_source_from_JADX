...
final class AccessTokenManager {
    ...
    AccessTokenManager(C0265i c0265i, AccessTokenCache accessTokenCache) {
    ...
    static AccessTokenManager getInstance() {
        if (instance == null) {
            synchronized (AccessTokenManager.class) {
                if (instance == null) {
                    instance = new AccessTokenManager(C0265i.m1105a(FacebookSdk.getApplicationContext()), new AccessTokenCache());
                }
            }
        }
        return instance;
