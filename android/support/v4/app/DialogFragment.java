...
public class DialogFragment extends Fragment implements OnCancelListener, OnDismissListener {
    ...
    public void show(C0202r c0202r, String str) {
        ...
        C0195t a = c0202r.mo150a();
        a.mo142a((Fragment) this, str);
        a.mo138a();
    }

    public int show(C0195t c0195t, String str) {
        this.mDismissed = false;
        this.mShownByMe = true;
        c0195t.mo142a((Fragment) this, str);
        this.mViewDestroyed = false;
        this.mBackStackId = c0195t.mo138a();
    ...
    void dismissInternal(boolean z) {
        if (!this.mDismissed) {
            ...
            if (this.mBackStackId >= 0) {
                getFragmentManager().mo152a(this.mBackStackId, 1);
                this.mBackStackId = -1;
                return;
            }
            C0195t a = getFragmentManager().mo150a();
            a.mo141a(this);
            if (z) {
                a.mo143b();
            } else {
    ...
    public LayoutInflater getLayoutInflater(Bundle bundle) {
        ...
        if (this.mDialog == null) {
            return (LayoutInflater) this.mHost.m537i().getSystemService("layout_inflater");
        }
