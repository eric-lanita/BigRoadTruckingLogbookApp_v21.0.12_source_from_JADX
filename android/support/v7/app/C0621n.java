...
class C0621n {
    ...
    public void m2883a(long j, double d, double d2) {
        ...
        if (sin >= 1.0d) {
            ...
            this.f1491a = Math.round((((double) acos) + sin2) * 8.64E7d) + 946728000000L;
            this.f1492b = Math.round((sin2 - ((double) acos)) * 8.64E7d) + 946728000000L;
            if (this.f1492b >= j || this.f1491a <= j) {
                this.f1493c = 1;
            } else {
                this.f1493c = 0;
            }
