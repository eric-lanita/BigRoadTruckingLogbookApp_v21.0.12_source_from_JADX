...
public final class C0072a {
    private static final String f401a = ("code_cache" + File.separator + "secondary-dexes");
    private static final Set<String> f402b = new HashSet();
    private static final boolean f403c = C0072a.m376a(System.getProperty("java.vm.version"));

    private static final class C0069a {
        private static void m365b(ClassLoader classLoader, List<File> list, File file) {
            Object obj = C0072a.m379b(classLoader, "pathList").get(classLoader);
            C0072a.m381b(obj, "dexElements", C0069a.m364a(obj, new ArrayList(list), file));
        }

        private static Object[] m364a(Object obj, ArrayList<File> arrayList, File file) {
            return (Object[]) C0072a.m380b(obj, "makeDexElements", ArrayList.class, File.class).invoke(obj, new Object[]{arrayList, file});
        }
    }

    private static final class C0070b {
        private static void m368b(ClassLoader classLoader, List<File> list, File file) {
            Object obj = C0072a.m379b(classLoader, "pathList").get(classLoader);
            ArrayList arrayList = new ArrayList();
            C0072a.m381b(obj, "dexElements", C0070b.m367a(obj, new ArrayList(list), file, arrayList));
            if (arrayList.size() > 0) {
                Iterator it = arrayList.iterator();
                while (it.hasNext()) {
                    Log.w("MultiDex", "Exception in makeDexElement", (IOException) it.next());
                }
                Field a = C0072a.m379b(classLoader, "dexElementsSuppressedExceptions");
        ...
        private static Object[] m367a(Object obj, ArrayList<File> arrayList, File file, ArrayList<IOException> arrayList2) {
            return (Object[]) C0072a.m380b(obj, "makeDexElements", ArrayList.class, File.class, ArrayList.class).invoke(obj, new Object[]{arrayList, file, arrayList2});
        }
    }

    private static final class C0071c {
        private static void m370b(ClassLoader classLoader, List<File> list) {
            int size = list.size();
            Field a = C0072a.m379b(classLoader, "path");
            ...
            C0072a.m381b((Object) classLoader, "mPaths", objArr);
            C0072a.m381b((Object) classLoader, "mFiles", objArr2);
            C0072a.m381b((Object) classLoader, "mZips", objArr3);
            C0072a.m381b((Object) classLoader, "mDexs", objArr4);
        }
    }

    /* JADX WARNING: inconsistent code. */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static void m373a(android.content.Context r6) {
        /*
        r4 = 20;
        r3 = 4;
        r0 = "MultiDex";
    ...
    L_0x001a:
        ...
        throw r0;
    L_0x0045:
        r0 = android.support.multidex.C0072a.m378b(r6);	 Catch:{ Exception -> 0x005d }
        if (r0 == 0) goto L_0x0015;
    L_0x004b:
        r1 = f402b;	 Catch:{ Exception -> 0x005d }
        monitor-enter(r1);	 Catch:{ Exception -> 0x005d }
        r2 = r0.sourceDir;	 Catch:{ all -> 0x005a }
        r3 = f402b;	 Catch:{ all -> 0x005a }
    ...
    L_0x00e9:
        ...
        goto L_0x0015;
    L_0x00f4:
        android.support.multidex.C0072a.m382c(r6);	 Catch:{ Throwable -> 0x0118 }
    L_0x00f7:
        r3 = new java.io.File;	 Catch:{ all -> 0x005a }
        r4 = r0.dataDir;	 Catch:{ all -> 0x005a }
        r5 = f401a;	 Catch:{ all -> 0x005a }
        r3.<init>(r4, r5);	 Catch:{ all -> 0x005a }
        r4 = 0;
        r4 = android.support.multidex.C0074b.m384a(r6, r0, r3, r4);	 Catch:{ all -> 0x005a }
        r5 = android.support.multidex.C0072a.m377a(r4);	 Catch:{ all -> 0x005a }
        if (r5 == 0) goto L_0x0121;
    L_0x010b:
        android.support.multidex.C0072a.m374a(r2, r3, r4);	 Catch:{ all -> 0x005a }
    L_0x010e:
        monitor-exit(r1);	 Catch:{ all -> 0x005a }
        r0 = "MultiDex";
        r1 = "install done";
    ...
    L_0x0121:
        ...
        r4 = 1;
        r0 = android.support.multidex.C0074b.m384a(r6, r0, r3, r4);	 Catch:{ all -> 0x005a }
        r4 = android.support.multidex.C0072a.m377a(r0);	 Catch:{ all -> 0x005a }
        if (r4 == 0) goto L_0x0137;
    L_0x0133:
        android.support.multidex.C0072a.m374a(r2, r3, r0);	 Catch:{ all -> 0x005a }
        goto L_0x010e;
    L_0x0137:
    ...
    private static ApplicationInfo m378b(Context context) {
        try {
    ...
    static boolean m376a(String str) {
        boolean z = false;
        if (str != null) {
    ...
    private static void m374a(ClassLoader classLoader, File file, List<File> list) {
        if (!list.isEmpty()) {
            if (VERSION.SDK_INT >= 19) {
                C0070b.m368b(classLoader, list, file);
            } else if (VERSION.SDK_INT >= 14) {
                C0069a.m365b(classLoader, list, file);
            } else {
                C0071c.m370b(classLoader, list);
            }
        }
    }

    private static boolean m377a(List<File> list) {
        for (File a : list) {
            if (!C0074b.m393a(a)) {
                return false;
            }
    ...
    private static Field m379b(Object obj, String str) {
    ...
    private static Method m380b(Object obj, String str, Class<?>... clsArr) {
        Class cls = obj.getClass();
        while (cls != null) {
            try {
    ...
    private static void m381b(Object obj, String str, Object[] objArr) {
        Field b = C0072a.m379b(obj, str);
    ...
    private static void m382c(Context context) {
