...
final class C0074b {
    private static Method f405a;

    static List<File> m384a(Context context, ApplicationInfo applicationInfo, File file, boolean z) {
        List<File> a;
        Log.i("MultiDex", "MultiDexExtractor.load(" + applicationInfo.sourceDir + ", " + z + ")");
        File file2 = new File(applicationInfo.sourceDir);
        long c = C0074b.m395c(file2);
        if (z || C0074b.m392a(context, file2, c)) {
            Log.i("MultiDex", "Detected that extraction must be performed.");
            a = C0074b.m386a(file2, file);
            C0074b.m387a(context, C0074b.m394b(file2), c, a.size() + 1);
        } else {
            try {
                a = C0074b.m385a(context, file2, file);
            } catch (Throwable e) {
    ...
    private static List<File> m385a(Context context, File file, File file2) {
        Log.i("MultiDex", "loading existing secondary dex files");
        String str = file.getName() + ".classes";
        int i = C0074b.m383a(context).getInt("dex.number", 1);
    ...
    private static boolean m392a(Context context, File file, long j) {
        SharedPreferences a = C0074b.m383a(context);
        return (a.getLong("timestamp", -1) == C0074b.m394b(file) && a.getLong("crc", -1) == j) ? false : true;
    }

    private static long m394b(File file) {
    ...
    private static long m395c(File file) {
        long a = C0076c.m397a(file);
        if (a == -1) {
            return a - 1;
        }
        return a;
    ...
    private static List<File> m386a(File file, File file2) {
        String str = file.getName() + ".classes";
        C0074b.m390a(file2, str);
        ...
        try {
            ...
            while (entry != null) {
                ...
                while (i2 < 3 && !z) {
                    int i3 = i2 + 1;
                    C0074b.m391a(zipFile, entry, file3, str);
                    boolean a = C0074b.m393a(file3);
    ...
    private static void m387a(Context context, long j, long j2, int i) {
        Editor edit = C0074b.m383a(context).edit();
    ...
    private static SharedPreferences m383a(Context context) {
        return context.getSharedPreferences("multidex.version", VERSION.SDK_INT < 11 ? 0 : 4);
    }

    private static void m390a(File file, final String str) {
        C0074b.m396d(file.getParentFile());
        C0074b.m396d(file);
    ...
    private static void m396d(File file) {
        file.mkdir();
        if (!file.isDirectory()) {
    ...
    private static void m391a(ZipFile zipFile, ZipEntry zipEntry, File file, String str) {
    ...
    static boolean m393a(java.io.File r4) {
        /*
    ...
    private static void m389a(Closeable closeable) {
        try {
            closeable.close();
        } catch (Throwable e) {
            Log.w("MultiDex", "Failed to close resource", e);
    ...
    static {
        try {
            f405a = Editor.class.getMethod("apply", new Class[0]);
        } catch (NoSuchMethodException e) {
            f405a = null;
        }
    }

    private static void m388a(Editor editor) {
        if (f405a != null) {
            try {
                f405a.invoke(editor, new Object[0]);
                return;
